...
private Long id;
- **IMPORTANTE**: que tenga en cada entidad @JsonBackReference o @JsonManagedReference, @JsonManagedReference no debe colocarse sobre toda la clase, sino sobre la propiedad que participa en una relación bidireccional, para ayudar a Jackson a evitar bucles infinitos al serializar entidades con relaciones padre-hijo (por ejemplo, @OneToMany y @ManyToOne).
    `;
